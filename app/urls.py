...
from app.views import TopicListView, TopicCreateView, TopicUpdateView, TopicDeleteView, RedactorListView, \
    RedactorDetailView, RedactorCreateView, RedactorUpdateView, RedactorDeleteView, NewspaperListView, \
    toggle_assign_to_newspaper, NewspaperDetailView, NewspaperCreateView, NewspaperUpdateView, NewspaperDeleteView
